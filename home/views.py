...
def home(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'home/index.html', {'form': form, 'members': members, 'activities': activities})
...
def home_en(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'home/index_en.html', {'form': form, 'members': members, 'activities': activities})
